...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        // HYİ portu ve otomatik gönderim timer’ı
        private SerialPort _hyiPort;
            ...
            this.Invoke((MethodInvoker)(() =>
            {
                switch (key)
                {
                    ...
                    case "Status":
                        ...
                        {
                            bool para1 = (st & 1) != 0;   // ana paraşüt flag’i
                            bool para2 = (st & 2) != 0;   // yedek flag’i

                            // Form1 içi ikon güncellemeleriniz…

                            // → Payload’a ilet:
                            if (_payloadForm != null && !_payloadForm.IsDisposed)
                            {
                                _payloadForm.Invoke((MethodInvoker)(() =>
                                    _payloadForm.UpdateParachuteStatus(para1, para2)
                                ));
                            }
                        }
                        break;
    ...
    else
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (_loraPort?.IsOpen == true)
                    _loraPort.Close();
                // şuan arduniodan suni veri aldığımız için 9600 baud hızını kullanıyoruz.
                //
        ...
        private void lblLonCaption_Click(object sender, EventArgs e)
        {

        }

        private void sendTeamId_Click(object sender, EventArgs e)
        {

        }

        private void takımIdtestBox_TextChanged_1(object sender, EventArgs e)
        {

        }

        private void cmbHyiPorts_SelectedIndexChanged(object sender, EventArgs e)
        {
